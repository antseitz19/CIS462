...
breed[rocket_head head]
breed[rocket_body body]
breed[rocket_base base]
...
to instructions
  ...
  print "The player may increase their collection rate for a specific resource when they have 20+ of any resource"
  print "Automatic Resource Collector cost: 1 Water, 2 Iron, 2 Wood"
  print "Head of rocketship cost: 20 Water, 50 iron, 40 wood"
  print "Body of rocketship cost:  35 Water, 70 iron, 75 wood"
  print "Base of the rocketship cost: 15 water, 35 iron, 40 wood"
  print "Game objective: collect resources to complete a rocket ship in order to escape the planet!"
end
...
to setup ; sets all starting conditions
  ...
  set-default-shape rocket_head "rocket 1"
  set-default-shape rocket_body "rocket 2"
  set-default-shape rocket_base "rocket 3"
...
to buy-head
  ...
  ask players[
    if numWater >= 20 and numIron >= 50 and numWood >= 40[
      set numWater numWater - 20
      set numIron numIron - 50
      set numWood numWood - 40
      ask patch round (HspawnX)(HspawnY)[ sprout-rocket_head 1 [
      set size 2
        ]
    ]
    ]
...
to buy-body
  ...
  let OspawnY 12
    ...
    ask players[
    if numWater >= 35 and numIron >= 70 and numWood >= 75[
      set numWater numWater - 35
      set numIron numIron - 70
      set numWood numWood - 75
      ask patch round (OspawnX)(OspawnY)[ sprout-rocket_body 1 [
      set size 2
        ]
    ]
    ]
...
to buy-base
  ...
  let BspawnY 10
    ...
    ask players[
    if numWater >= 15 and numIron >= 35 and numWood >= 40[
      set numWater numWater - 15
      set numIron numIron - 35
      set numWood numWood - 40
      ask patch round (BspawnX)(BspawnY)[ sprout-rocket_base 1 [
      set size 2
        ]
    ]
    ]
